...
class JournalModel {
    ...
    fileprivate func createJournals()
    {
        ...
        items.append(Journal(name: "Out East", location: "New York, NY", startDate: Date.distantFuture, endDate: Date.init(timeInterval: 100000, since: Date.distantFuture), lat: 40.3772059, lng: -105.5216651, placeId: "ChIJAxoZu9ZlaYcRDKzKqbeYlts"))
    }
}
