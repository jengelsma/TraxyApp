...
class MapViewController: TraxyTopLevelViewController {
    ...
    override func viewDidLoad() {
        ...
        let camera = GMSCameraPosition.camera(withLatitude: 39.844546,  longitude: -101.304128, zoom: 3.0)
    ...
    func askForLocationPermits()
    {
        ...
        if let lastUpdate = UserDefaults.standard.object(forKey: "LastAskedForLocationPermits") as? Date {
